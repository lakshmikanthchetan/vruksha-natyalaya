      ...
      <div className="w-full mb-10">
        ...
        <Card>
          ...
          <p className="mb-4 font-normal text-gray-700 dark:text-gray-400">
            ...
            being acted out through dance (Abhinaya). The footwork, body
            language, postures, musical notes, the tones of the vocalist,
            aesthetics and costumes integrate to express and communicate the
            underlying text.
          </p>
          <p className="mb-4 font-normal text-gray-700 dark:text-gray-400">
